...
- Добавлен новый хук `useArray`, благодаря которой автоматически создаётся массив, в callback-функции которой можно добавлять некоторые предметы, а хук возвращает добавленный массив.
